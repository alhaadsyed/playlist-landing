export default function LuxuryPlaylistLinksWithBackground() {
  return (
    // 1. Layout changed to 'justify-between' to spread elements top, middle, and bottom
    // 2. Added a subtle warm gradient to the bottom so it doesn't end in stark white
    <div
      className="flex flex-col items-center justify-between min-h-screen p-6 font-sans bg-gradient-to-b from-white via-white to-[#F9F6F0] bg-[length:100%_auto] md:bg-cover bg-top md:bg-center bg-no-repeat"
    ...
    >
      ...
      <div className="bg-white/80 backdrop-blur-2xl border border-[#F2EDE4] shadow-[0_20px_50px_-12px_rgba(197,160,89,0.1)] rounded-2xl p-10 w-full max-w-sm flex flex-col items-center relative overflow-hidden my-auto">
        ...
        {/* Added: A subtle description to give the card more body with strong, readable contrast */}
        ...
        {/* Buttons (Preserved your new text!) */}
